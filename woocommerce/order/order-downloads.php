...
?>
<section class="woocommerce-order-downloads table-responsive">
						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								case 'download-product':
									...
									break;
								case 'download-file':
									echo '<a href="' . esc_url( $download['download_url'] ) . '" class="woocommerce-MyAccount-downloads-file button alt">'.esc_html( $download['download_name'] ).' <i title="'.esc_html( $download['download_name'] ).'" class="fas fa-cloud-download-alt"></i></a>';
									break;
