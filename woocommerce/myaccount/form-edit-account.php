...
<div class="edit-account row align-items-end">


	<p class="col-12 col-md-6 col-lg-4 woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
	...
	<p class="col-12 col-md-6 col-lg-4 woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
	...
	<p class="col-12 col-md-6 col-lg-4 woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        <span><em class="text-muted"><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'woocommerce' ); ?></em></span>
        <label for="account_display_name"><?php esc_html_e( 'Display name', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
		<input type="text" class="form-control woocommerce-Input woocommerce-Input--text input-text" name="account_display_name" id="account_display_name" value="<?php echo esc_attr( $user->display_name ); ?>" />
	</p>
	<div class="clear"></div>
	...
	<fieldset >
		<legend><?php esc_html_e( 'Password change', 'woocommerce' ); ?></legend>
            <div class="edit-account-password row align-items-end">
	...
	<p>
		...
		<button type="submit" class="woocommerce-Button button btn btn-dark" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
